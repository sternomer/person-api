...
type PersonServiceClient interface {
	...
	ReadPerson(ctx context.Context, in *ReadPersonReq, opts ...grpc.CallOption) (*Person, error)
...
func (c *personServiceClient) ReadPerson(ctx context.Context, in *ReadPersonReq, opts ...grpc.CallOption) (*Person, error) {
	out := new(Person)
...
func (x *personServiceListPersonsClient) Recv() (*Person, error) {
	m := new(Person)
...
type PersonServiceServer interface {
	...
	ReadPerson(context.Context, *ReadPersonReq) (*Person, error)
...
func (UnimplementedPersonServiceServer) ReadPerson(context.Context, *ReadPersonReq) (*Person, error) {
...
func (x *personServiceListPersonsServer) Send(m *Person) error {
